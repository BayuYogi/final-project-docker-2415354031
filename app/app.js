...
// 1. Ambil nilai dari environment variable, gunakan 3000 sebagai cadangan (fallback) jika kosong
const PORT = process.env.APP_PORT && process.env.APP_PORT !== '' ? process.env.APP_PORT : 3000;

// 2. Jalankan server menggunakan variabel PORT yang sudah divalidasi
app.listen(PORT, "0.0.0.0", () => {
  // 3. Gunakan string literal (``) agar log dinamis mengikuti port asli
